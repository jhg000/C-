// 20221123_jhg_test1.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
double find_min_float(double d, double e, double f);
int main()
{
    int a = 0, b = 0, c = 0;
    int min = 0, max = 0;
...
double find_max(double d, double e, double f)
{
    int max = d;
...
double find_min(double d, double e, double f)
{
    int min = d;
    min = (d < min) ? d : min;
    min = (e < min) ? e : min;
